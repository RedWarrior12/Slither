local mode = 1 -- Starting mode. 0 = Legit, wont hit 100% accurately : 1 = Rage, hits everythings with 100% accuracy : 2 = Disabled
local maxdelay = .01 -- Maximum delay b4 hitting a note while using legit mode, recomending max is .16, any higher and youll start missing a lot
